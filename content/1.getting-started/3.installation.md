...
Initialization of a new project. Changed!

::prose-accordion{type="multiple"}
  :::prose-accordion-item{label="Hola"}
  ## contenido del acordeon
  :::
::

![mountains.webp](/mountains.webp)
...
### Deploy in one click2

Once your project has been created and initialized and you're in the project dashboard, navigate to the `Deploy` section, choose the `GitHub Pages` tab and set your [Nuxt UI Pro license](https://ui.nuxt.com/pro/pricing) (`NUXT_UI_PRO_LICENSE` ) in the environment variables then click on the **Deploy** button.
